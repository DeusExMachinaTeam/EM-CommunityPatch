//////////////////////////////////////////////////////////////////////////////
//
// Workfile: tree_noLights.fx
// Created by: Plus
//
// simple plant shader
//
// $Id: tree_noLights.fx,v 1.4 2005/09/06 10:56:14 vano Exp $
//
//////////////////////////////////////////////////////////////////////////////
...
{
	return tex2D( DiffSampler, In.Tex0 ) * float4( plantColor.xyz, 1.0f);
}


technique TreeTech
<
	string 	Description = "plant shader (w/o lighting)";
