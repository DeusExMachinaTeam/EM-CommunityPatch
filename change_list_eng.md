...
### Cutscenes
* **Krai - Intro cutscene**: main character no longer flies in the air in the intro cutscene, firmly staying on the ground  [[#189]](https://github.com/DeusExMachinaTeam/EM-CommunityPatch/pull/189)
...
* **Krai - Show local villages to Alice**: player will no longer be able to go around and skip the location where we first meet Lisa near Sowth, size of the cutscene activation is larger [[#180]](https://github.com/DeusExMachinaTeam/EM-CommunityPatch/pull/180)
...
* **Vaterland - Catch the runner at the abandoned town**: Runaway bandit will now follow his predefined path and patrol the abandoned town instead of standing in place [[#138]](https://github.com/DeusExMachinaTeam/EM-CommunityPatch/pull/138)
